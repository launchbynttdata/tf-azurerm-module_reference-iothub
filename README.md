...
| <a name="input_eventhub_namespace_network_rule_set"></a> [eventhub\_namespace\_network\_rule\_set](#input\_eventhub\_namespace\_network\_rule\_set) | (Optional) Network rule set for the EventHub Namespace.<br/>  Defaults deny public traffic while allowing trusted Azure services. | <pre>object({<br/>    default_action                 = optional(string, "Deny")<br/>    trusted_service_access_enabled = optional(bool, true)<br/>    ip_rules = optional(list(object({<br/>      ip_mask = string<br/>      action  = optional(string, "Allow")<br/>    })), [])<br/>    virtual_network_rules = optional(list(object({<br/>      subnet_id                                       = string<br/>      ignore_missing_virtual_network_service_endpoint = optional(bool, false)<br/>    })), [])<br/>  })</pre> | <pre>{<br/>  "default_action": "Deny",<br/>  "ip_rules": [],<br/>  "trusted_service_access_enabled": true,<br/>  "virtual_network_rules": []<br/>}</pre> | no |
