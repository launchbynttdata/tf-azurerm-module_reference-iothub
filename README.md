...
| <a name="input_iothub_public_network_access_enabled"></a> [iothub\_public\_network\_access\_enabled](#input\_iothub\_public\_network\_access\_enabled) | (Optional) Is the IotHub resource accessible from a public network? Defaults to true. | `bool` | `true` | no |
...
| <a name="input_iothub_dps_public_network_access_enabled"></a> [iothub\_dps\_public\_network\_access\_enabled](#input\_iothub\_dps\_public\_network\_access\_enabled) | (Optional) Boolean flag to specify whether or not public network access is enabled or not. Defaults to true. | `bool` | `true` | no |
