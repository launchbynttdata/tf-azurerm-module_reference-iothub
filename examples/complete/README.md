...
| <a name="input_eventhub_namespace_public_network_access_enabled"></a> [eventhub\_namespace\_public\_network\_access\_enabled](#input\_eventhub\_namespace\_public\_network\_access\_enabled) | Enable EventHub Namespace public endpoint. | `bool` | `true` | no |
| <a name="input_eventhub_namespace_network_rule_set"></a> [eventhub\_namespace\_network\_rule\_set](#input\_eventhub\_namespace\_network\_rule\_set) | EventHub Namespace network rule set. Default keeps public access enabled with Allow. | <pre>object({<br/>    default_action                 = optional(string, "Allow")<br/>    trusted_service_access_enabled = optional(bool, true)<br/>    ip_rules = optional(list(object({<br/>      ip_mask = string<br/>      action  = optional(string, "Allow")<br/>    })), [])<br/>    virtual_network_rules = optional(list(object({<br/>      subnet_id                                       = string<br/>      ignore_missing_virtual_network_service_endpoint = optional(bool, false)<br/>    })), [])<br/>  })</pre> | <pre>{<br/>  "default_action": "Allow",<br/>  "ip_rules": [],<br/>  "trusted_service_access_enabled": true,<br/>  "virtual_network_rules": []<br/>}</pre> | no |
...
| <a name="input_create_iothub_private_endpoint"></a> [create\_iothub\_private\_endpoint](#input\_create\_iothub\_private\_endpoint) | Create a private endpoint for IoT Hub. | `bool` | `false` | no |
| <a name="input_iothub_private_endpoint_subnet_id"></a> [iothub\_private\_endpoint\_subnet\_id](#input\_iothub\_private\_endpoint\_subnet\_id) | Subnet resource ID for IoT Hub private endpoint. Required when private endpoint creation is enabled. | `string` | `null` | no |
| <a name="input_iothub_private_endpoint_private_dns_zone_group_name"></a> [iothub\_private\_endpoint\_private\_dns\_zone\_group\_name](#input\_iothub\_private\_endpoint\_private\_dns\_zone\_group\_name) | Private DNS zone group name for IoT Hub private endpoint. | `string` | `""` | no |
| <a name="input_iothub_private_endpoint_private_dns_zone_ids"></a> [iothub\_private\_endpoint\_private\_dns\_zone\_ids](#input\_iothub\_private\_endpoint\_private\_dns\_zone\_ids) | Private DNS zone IDs for IoT Hub private endpoint. | `list(string)` | `[]` | no |
| <a name="input_iothub_private_endpoint_is_manual_connection"></a> [iothub\_private\_endpoint\_is\_manual\_connection](#input\_iothub\_private\_endpoint\_is\_manual\_connection) | Whether IoT Hub private endpoint requires manual approval. | `bool` | `false` | no |
| <a name="input_iothub_private_endpoint_subresource_names"></a> [iothub\_private\_endpoint\_subresource\_names](#input\_iothub\_private\_endpoint\_subresource\_names) | Subresource names for IoT Hub private endpoint. | `list(string)` | <pre>[<br/>  "iotHub"<br/>]</pre> | no |
| <a name="input_iothub_private_endpoint_request_message"></a> [iothub\_private\_endpoint\_request\_message](#input\_iothub\_private\_endpoint\_request\_message) | Request message for manual private endpoint approval for IoT Hub. | `string` | `null` | no |
